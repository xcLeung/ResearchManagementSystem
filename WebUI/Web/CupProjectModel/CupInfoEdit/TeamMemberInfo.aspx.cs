...
namespace ResearchManagementSystem.Web.CupProjectModel.CupInfoEdit
{
    public partial class TeamMemberInfo : System.Web.UI.Page
    {
        ...
        protected List<Models.DB.CupTeamMemberInfo> TeamMemberList = new List<Models.DB.CupTeamMemberInfo>();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            TeamMemberList = BLL.CupTeamMemberInfo.SelectByProjectId(ProjectID);
        }
