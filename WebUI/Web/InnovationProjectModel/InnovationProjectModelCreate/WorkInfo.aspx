<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Master.Master" AutoEventWireup="true" CodeBehind="WorkInfo.aspx.cs" Inherits="ResearchManagementSystem.Web.InnovationProjectModel.InnovationProjectModelCreate.WorkInfo" %>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#btn").bind("click", function () {
                ...
                if (s == "success") {
                    alert("操作成功！");
                    window.location.href = "../InnovationProjectModelEdit/WorkInfo.aspx?ProjectID=<%=ProjectID %>";
                } else {
                    alert("操作失败！");
                }
            });
    ...
    <div class="layout">
        <form id="MyFormID">
            ...
            <div>
                ...
                <input type="text" name="SecondCategories"  />              
            </div>
            <div> 
            ...
            <div> 
                ...
                <textarea name="SpecificPlan" class="text"></textarea>
            ...
            <div> 
                ...
                <textarea name="PracticalsStep" class="text"></textarea>
            ...
            <div> 
                ...
                <textarea name="Expection" class="text"></textarea>
            ...
            <div> 
                ...
                <textarea name="Budget" class="text"></textarea>
            ...
            <div> 
                ...
                <textarea name="InterimReport" id="InterimReport" class="text"></textarea>
            ...
            <div> 
                ...
                <textarea name="SubmitAchievement" id="SubmitAchievement" class="text"></textarea>
            ...
            <div> 
                ...
                <textarea name="Managementbasis" id="Managementbasis" class="text"></textarea>
