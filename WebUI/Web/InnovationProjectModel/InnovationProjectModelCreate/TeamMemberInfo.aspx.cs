...
namespace ResearchManagementSystem.Web.InnovationProjectModel.InnovationProjectModelCreate
{
    public partial class TeamMemberInfo : System.Web.UI.Page
    {
        ...
        private void initData()
        {
            ...
            if (BLL.InnovationTeamMember.CountByProjectID(ProjectID) > 0)
            {
                Response.Redirect(String.Format("~/Web/InnovationProjectModel/InnovationProjectModelEdit/TeamMemberInfo.aspx?ProjectID={0}", ProjectID));
            }
        }
