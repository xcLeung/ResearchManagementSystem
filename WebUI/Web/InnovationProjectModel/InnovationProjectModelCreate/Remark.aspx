<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Master.Master" AutoEventWireup="true" CodeBehind="Remark.aspx.cs" Inherits="ResearchManagementSystem.Web.InnovationProjectModel.InnovationProjectModelCreate.Remark" %>
       ...
       <div class="ProjectStatu">当前作品状态</div>
        ...
        <div id="rightside">
            ...
            <div class="layoutText">
                    ...
                    <textarea id="Remark" class="text"><%=Projects[0].Remark==""?"无":Projects[0].Remark %></textarea>
