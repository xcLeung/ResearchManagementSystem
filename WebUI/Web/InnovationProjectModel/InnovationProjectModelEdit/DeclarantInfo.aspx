<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Master.Master" AutoEventWireup="true" CodeBehind="DeclarantInfo.aspx.cs" Inherits="ResearchManagementSystem.Web.InnovationProjectModel.InnovationProjectModelEdit.DeclarantInfo" %>
        ...
        $(document).ready(function () {
            ...
            $("#btn").bind("click", function () {
                if ($("#myFormId").jFormIsOk()) {
                    ...
                    if (s == "success") {
                        alert("操作成功！");
                        window.location.href = "../InnovationProjectModelCreate/DeclarantInfo.aspx?ProjectID=<%=ProjectID %>";
                    } else {
                        alert("操作失败！");
                    }
                }
            ...
            <div class="layout">
                ...
                <div>
                 ...
                 <div>
                      ...
                      <input type="text" id="Phone" jformtype="mobile" value="<%=Declarant.Phone %>"/>
                ...
                <div>
                    ...
                    <textarea name="Experience" id="Experience" class="text" style="margin-left:140px;"><%=Declarant.Experience %></textarea>
